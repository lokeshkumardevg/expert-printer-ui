export default function Icon({ name, cls = "w-4 h-4" }) {
  if (name === "dots")
    return <svg className={cls} fill="currentColor" viewBox="0 0 24 24"><circle cx="12" cy="5" r="1.5"/><circle cx="12" cy="12" r="1.5"/><circle cx="12" cy="19" r="1.5"/></svg>;
  ...
  const paths = {
    ...
    users:       <path strokeLinecap="round" strokeLinejoin="round" d="M17 20h5v-2a4 4 0 00-5.197-3.792M9 20H4v-2a4 4 0 015.197-3.792m0 0A4 4 0 1112 7a4 4 0 012.803 7.208M15 7a3 3 0 11-6 0 3 3 0 016 0z"/>,
    ...
    book:        <path strokeLinecap="round" strokeLinejoin="round" d="M12 6.042A8.967 8.967 0 006 3.75c-1.052 0-2.062.18-3 .512v14.25A8.987 8.987 0 016 18c2.312 0 4.47.636 6.308 1.742m0-13.7a8.967 8.967 0 016-2.292c1.052 0 2.062.18 3 .512v14.25A8.987 8.987 0 0018 18c-2.312 0-4.47.636-6.308 1.742m0-13.7V21"/>,
